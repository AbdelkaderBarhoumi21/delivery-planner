...
class AppOrderTitleVerifyIcon extends StatelessWidget {
  const AppOrderTitleVerifyIcon({
    super.key,
    required this.title,
    this.maxLines = 1,
    this.textColor,
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Icon(iconData, color: iconColor, size: AppSizes.iconXs),
      ],
    );
  }
}
